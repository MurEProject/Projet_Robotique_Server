        ...
        public GPS() throws Exception
         {
                ...
                System.out.println("connection utilisant les réglages suivants: 9600/N/8/l");
	...
	public void dataReceived(SerialDataEvent event)
         {
                ...
                if (trame.contains("$GPGGA") && trame.contains("$GPRMC") && trame.contains("$GPVTG"))
                 {
                                ...
                                if (lat_long[i].contains("$GPGGA") && lat_long[i].contains("*"))
                                 {
                                        ...
                                        lat = Float.valueOf(GPGGA[2].substring(0,2)) +  Float.valueOf(GPGGA[2].substring(2))/60;
                                        lg = Float.valueOf(GPGGA[4].substring(0,3)) +  Float.valueOf(GPGGA[4].substring(3))/60;
